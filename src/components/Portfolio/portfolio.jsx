          ...
          <div className="gallery full-width">
            ...
            >
              <div className="item-img">
                <Link legacyBehavior href={`/project-details2/project-details2-dark`}>
              ...
              <div className="cont">
                ...
                <span>
                  <Link legacyBehavior href="/works/works-dark">Design</Link>, <Link legacyBehavior href="/works/works-dark">WordPress</Link>
                </span>
              </div>
            </div>
