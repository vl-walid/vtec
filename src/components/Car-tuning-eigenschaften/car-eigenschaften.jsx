...
const CarEigenschaften = ({ car_id, tuning_id }) => {
    ...
    if (car_id && tuning_id) {
      try {
        const vehicleResponse = await axios.get(
          `https://back-end.topspeed-performance.de/api/vehicle/stage-and-name`, 
    ...
    if (car_id && tuning_id) {
      try {
        const response = await axios.get(
          `https://back-end.topspeed-performance.de/api/vehicle/characteristics-by-tuning-id`,
  ...
  const addToVehicle = async (characteristic_id) => {
    try {
      ...
      await axios.post(
        `https://back-end.topspeed-performance.de/api/vehicle/add-characteristics-tuning`,
        null,
  ...
  const removeCharacteristic = async (id) => {
    try {
      await axios.delete(
        `https://back-end.topspeed-performance.de/api/vehicle/tuning/characteristic-delete/`,
        {
          data: {
            vehicle_id: car_id,
            tuning_id: tuning_id,
